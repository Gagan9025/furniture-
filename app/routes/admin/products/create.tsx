    ...
    <AdminLayout>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-royal-silver-800">Add New Product</h1>
          <p className="text-royal-silver-600 mt-2">Create a new product for your catalog</p>
        </div>
